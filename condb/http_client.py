...
class ServerSideError(ConDBError):
    pass

class PermissionError(ConDBError):
    pass

class BadRequestError(ConDBError):
    pass

class NotFoundError(ConDBError):
    pass

class WebAPIError(ConDBError):
    pass
...
class HTTPClient(object):
    ...
    def __init__(self, server_url, token=None, timeout=100):
    ...
    def send_request(self, method, uri_suffix, headers=None, timeout=None, **args):
        ...
        self.raise_on_error(url, response)
        return response

    def get_text(self, uri_suffix):
        return self.send_request("get", uri_suffix).text

    def post_text(self, uri_suffix, data, **args):
        return self.send_request("post", uri_suffix, data, **args).text
    ...
    def post(self, uri_suffix, data, **args):
        ...
        response = self.retry_request("post", url, data=data, headers=headers, **args)
